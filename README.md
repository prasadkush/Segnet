...
1. The encoder consists of the following blocks:
    ...
    - Blocks 4 - 7: 2 7 x 7 conv layers (input ch = 128, out ch = 128) followed by 1 x 1 conv layer in parallel with 2 3 x 3 conv layers (input ch = 128, out ch = 128, dilation 2 for block 4, 4 for block 5, 6 for block 6, 8 for block 8) folllowed by 1 x 1 conv layer and concatenation of the 2 parallel streams. Each conv layer in blocks 4 - 7 is followed by batchnorm, dropout and PRelu. Each block in 4-7 receives a residual connection from the previous layer.
